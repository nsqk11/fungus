#!/usr/bin/env python3
"""Memory store: SQLite persistence for extracted fragments.
...
if __name__ == "__main__":
    usage = (
        "Usage:\n"
        "  memory.py save <extractor> '<json_array>' [session_id]\n"
        "  memory.py finish <session_id> [count]\n"
